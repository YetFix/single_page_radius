...
<title>Offline Customer List</title>
...
.btn-reset{background:linear-gradient(135deg,#14b8a6,#0d9488);color:#fff;box-shadow:0 3px 10px rgba(20,184,166,.3)}
...
.last-cell{font-size:12px;color:var(--muted)}
.offline-badge{display:inline-flex;align-items:center;gap:4px;padding:3px 9px;background:#fee2e2;color:#b91c1c;border-radius:5px;font-size:11px;font-weight:700}
...
<body>
<div class="page" x-data="offlineApp()" x-cloak>

  <!-- Header -->
  <div class="page-head">
    <div class="page-title"><i class="fa-solid fa-plug-circle-xmark"></i> Offline Customer List</div>
  </div>
  ...
  <div class="note-banner">
    ...
    <div><strong>Note:</strong> যদি অফলাইন রেজাল্ট না দেখায়, তাহলে POP-এর MikroTik সফটওয়্যারের সাথে সংযুক্ত আছে কিনা তা চেক করুন। সমস্যা সমাধান না হলে নেটওয়ার্ক ইঞ্জিনিয়ারের সাথে যোগাযোগ করুন।</div>
  </div>
      ...
      <table>
        ...
        <tbody>
          <template x-if="searching">
            <tr class="searching-row"><td colspan="10"><i class="fa-solid fa-spinner fa-spin"></i>Searching offline customers…</td></tr>
          </template>
          <template x-if="!searching && paged.length===0">
            <tr class="empty-row"><td colspan="10"><i class="fa-solid fa-plug-circle-xmark"></i>No data available in table</td></tr>
          </template>
          <template x-for="r in paged" :key="r.id">
            <tr>
              ...
              <td x-text="r.pop"></td>
              <td x-text="r.area"></td>
              <td><span class="last-cell" x-text="r.lastOnline"></span></td>
              <td><span class="offline-badge"><i class="fa-regular fa-clock"></i><span x-text="r.offlineSince"></span></span></td>
              <td>
...
function offlineApp(){
  return {
    ...
    allCustomers:[
      {id:1,username:'akash99',ip:'10.10.2.77',mac:'48:8F:5A:12:F4:60',manager:'Net Vision',pop:'Dhaka POP-2',area:'Mirpur-10',lastOnline:'2026-06-10 22:41',offlineSince:'14h 12m',status:'Offline'},
      {id:2,username:'mirpur_user2',ip:'172.16.5.32',mac:'CC:2D:E0:91:0C:77',manager:'Delta ISP',pop:'Mirpur POP',area:'Mirpur-10',lastOnline:'2026-06-09 08:15',offlineSince:'2d 04h',status:'Offline'},
      {id:3,username:'kamal_dh',ip:'10.10.1.88',mac:'D4:CA:6D:66:1B:29',manager:'Karim Traders',pop:'Dhaka POP-1',area:'Dhanmondi',lastOnline:'2026-06-11 03:02',offlineSince:'9h 50m',status:'Offline'},
      {id:4,username:'nazmul_as',ip:'10.10.9.42',mac:'E4:8D:8C:91:33:DA',manager:'Net Vision',pop:'Rangpur POP',area:'Ashulia',lastOnline:'2026-06-05 17:30',offlineSince:'5d 19h',status:'Offline'},
      {id:5,username:'rasel_rng',ip:'10.10.9.27',mac:'E4:8D:8C:55:09:4C',manager:'Karim Traders',pop:'Rangpur POP',area:'Rangpur Sadar',lastOnline:'2026-06-10 11:58',offlineSince:'1d 01h',status:'Offline'},
      {id:6,username:'shanto_mp',ip:'172.16.5.49',mac:'CC:2D:E0:13:77:B8',manager:'Delta ISP',pop:'Mirpur POP',area:'Mirpur-10',lastOnline:'2026-06-08 20:22',offlineSince:'2d 16h',status:'Offline'},
    ],
    rows:[],
